...
const translations = {
  es: {
    ...
    "settings.certificateHelp": "Sube el certificado .pfx del cliente para poder remitir facturas a AEAT desde este perfil fiscal.",
    "settings.certificateFile": "Archivo .pfx",
    "settings.selectPfx": "Seleccionar certificado .pfx",
    ...
    "settings.certificateFileRequired": "Selecciona un archivo .pfx",
    ...
    "placeholder.certificatePassword": "Clave del .pfx",
  ...
  en: {
    ...
    "settings.certificateHelp": "Upload the client's .pfx certificate to submit invoices to AEAT from this taxpayer profile.",
    "settings.certificateFile": ".pfx file",
    "settings.selectPfx": "Select .pfx certificate",
    ...
    "settings.certificateFileRequired": "Select a .pfx file",
    ...
    "placeholder.certificatePassword": ".pfx password",
