...
export function AuthLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="vf-auth relative grid min-h-screen w-screen overflow-hidden bg-slate-950 text-white lg:grid-cols-[1.1fr_0.9fr]">
      <div className="vf-auth-language absolute right-6 top-6 z-10 w-44">
        <LanguageSwitcher />
      </div>

      <section className="vf-auth-hero relative hidden min-h-screen flex-col justify-between overflow-hidden bg-[radial-gradient(circle_at_20%_20%,rgba(56,189,248,0.35),transparent_32%),linear-gradient(135deg,#002b74_0%,#0057c8_48%,#00a3ff_100%)] p-12 lg:flex">
        ...
        <div className="vf-auth-brand relative flex items-center gap-3">
          <div className="vf-auth-logo flex h-12 w-12 items-center justify-center rounded-2xl bg-white/18 shadow-2xl ring-1 ring-white/25 backdrop-blur">
        ...
        <div className="vf-auth-copy relative max-w-2xl">
        ...
        <div className="vf-auth-kpis relative grid grid-cols-3 gap-3 text-sm text-sky-50/80">
      ...
      <section className="vf-auth-panel flex min-h-screen items-center justify-center bg-[linear-gradient(180deg,#f8fbff_0%,#eef4fb_100%)] px-6 py-12 text-slate-950">
        <div className="w-full max-w-md">
          ...
          <div className="vf-auth-card rounded-3xl border border-white/80 bg-white/88 px-8 py-9 shadow-2xl shadow-slate-900/10 backdrop-blur">
